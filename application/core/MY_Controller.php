...
class MY_Controller extends MX_Controller {
	...
	public function admin_load_page($page, $data = array()){
		$data['__assets__'] = $this->assets_;
      	$this->load->view('includes/admin_head',$data);
      	$this->load->view($page,$data);
      	$this->load->view('includes/admin_footer',$data);
    }
	public function user_load_page($page, $data = array()){
		$data['__assets__'] = $this->assets_;
      	$this->load->view('includes/user_head',$data);
      	$this->load->view($page,$data);
      	$this->load->view('includes/user_footer',$data);
    }
	...
	public function student_load_page($page, $data = array()){
		$data['__assets__'] = $this->assets_;
      	$this->load->view('includes/student_head',$data);
      	$this->load->view($page,$data);
