...
class SampleA extends MY_Controller
{
    public function index()
    {
        if (isset($_SESSION['userdata'])) {
            ...
            if ($session->user_type == "2") {
                ...
                $data['information'] = $this->MY_Model->getRows('questionaire', '', 'obj');
                // $data['user_id'] = 
                $this->student_load_page('sampleA', $data);
            } else {
                redirect(base_url());
            }
    ...
    function sampleAform()
    {
        ...
        $query = "SELECT * FROM questionaire " . $test;
        $temp = rtrim($query, "OR");
        $temp .= ";";
    ...
    { //kuha sa question id ug sa answer
        ...
        $result = getrow('questionaire', $param, 'row');
